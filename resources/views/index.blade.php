...
<!-- Mirrored from frontend.big-skins.com/seiko/html/ by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 17 Jul 2023 13:35:09 GMT -->
<head>
    <meta charset="utf-8">
...
<div class="fixed-btns demo-mode">
    ...
    <div id="toolsPanel">
        <div class="btn-wrapper tools-btn">
            <a href="#" class="btn"><img src="{{asset('assets/images/animate-tools.gif')}}" class="img-responsive" alt=""></a>
        </div>
        ...
        <div class="panel-group" id="toolsAccord">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h4 class="panel-title">
                        <a data-toggle="collapse" data-parent="#toolsAccord" href="#collapseOne"><i class="icon icon-tool-layout"></i>Layout Mode</a>
                    </h4>
                </div>
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h4 class="panel-title">
                        <a data-toggle="collapse" data-parent="#toolsAccord" href="#collapseTwo"><i class="icon icon-tool-side"></i>Side Panel</a>
                    </h4>
                </div>
                <div id="collapseTwo" class="panel-collapse collapse">
                    <div class="panel-body">
                        <div class="checkbox-group">
                            ...
                            <label for="checkbox1"><span class="check"></span><span class="box"></span>SHOW</label>
                        </div>
                    </div>
                </div>
            </div>
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h4 class="panel-title">
                        <a data-toggle="collapse" data-parent="#toolsAccord" href="#collapseThree"><i class="icon icon-tool-round"></i>Rounded</a>
                    </h4>
                </div>
                <div id="collapseThree" class="panel-collapse collapse">
                    <div class="panel-body">
                        <div class="checkbox-group">
                            ...
                            <label for="checkbox2"><span class="check"></span><span class="box"></span>ON</label>
                        </div>
                    </div>
                </div>
            </div>
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h4 class="panel-title">
                        <a data-toggle="collapse" data-parent="#toolsAccord" href="#collapseFour"><i class="icon icon-tool-header"></i>Header</a>
                    </h4>
                </div>
                <div id="collapseFour" class="panel-collapse collapse">
                    <div class="panel-body">
                        ...
                        <div class="checkbox-group">
                            ...
                            <label for="checkbox3"><span class="check"></span><span class="box"></span>ON</label>
                        </div>
                        <div class="divider"></div>
                        <h5>blackout</h5>
                        <div class="checkbox-group">
                            <input type="checkbox" name="blackout" id="checkbox4">
                            <label for="checkbox4"><span class="check"></span><span class="box"></span>ON</label>
                        </div>
                        <div class="divider"></div>
                        <h5>animation</h5>
                        <div class="radioset">
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h4 class="panel-title">
                        <a data-toggle="collapse" data-parent="#toolsAccord" href="#collapseFive"><i class="icon icon-tool-color"></i>Color Scheme</a>
                    </h4>
                </div>
                <div id="collapseFive" class="panel-collapse collapse">
                    <div class="panel-body">
                        <ul class="color-list">
                            <li class="active"><a href="#" title="Red" data-tooltip="Red"><span class="value" data-color=""><span class="color color-red"></span></span></a></li>
                            <li><a href="#" data-tooltip="Orange" title="Orange" data-color="color-orange"><span class="value"><span class="color color-orange"></span></span></a></li>
                            <li><a href="#" data-tooltip="Blue" title="Blue" data-color="color-blue"><span class="value"><span class="color color-blue"></span></span></a></li>
                            <li><a href="#" data-tooltip="Light Green" title="Light Green" data-color="color-lightgreen"><span class="value"><span class="color color-lightgreen"></span></span></a></li>
                            <li><a href="#" data-tooltip="Green Caribbean" title="Green Caribbean" data-color="color-caribbean"><span class="value"><span class="color color-caribbean"></span></span></a></li>
                            <li><a href="#" data-tooltip="Green" title="Green" data-color="color-green"><span class="value"><span class="color color-green"></span></span></a></li>
                            <li><a href="#" data-tooltip="Pink" title="Pink" data-color="color-pink"><span class="value"><span class="color color-pink"></span></span></a></li>
                            <li><a href="#" data-tooltip="Violet" title="Violet" data-color="color-violet"><span class="value"><span class="color color-violet"></span></span></a></li>
                            <li><a href="#" data-tooltip="Light Blue" title="Light Blue" data-color="color-lightblue"><span class="value"><span class="color color-lightblue"></span></span></a></li>
                            <li><a href="#" data-tooltip="Tomato" title="Tomato" data-color="color-tomato"><span class="value"><span class="color color-tomato"></span></span></a></li>
                        </ul>
                    </div>
                </div>
            </div>
    ...
    <!-- Tools Panel -->
    <!-- Buy Now -->
    <a href="https://themeforest.net/item/seiko-html-mobile-first/18941342?ref=bigsteps" target="_blank" class="buy-fixed-btn btn"><i class="icon icon-star"></i>BUY THEME</a>
    <!-- /Buy Now -->
    <!-- Back To Top -->
                ...
                <div class="container">
                                                ...
                                                <li class="item product product-item">
                                                    <div class="product">
                                                        <a class="product-item-photo" href="#" title="Long sleeve overall">
																...
																<img class="product-image-photo" src="{{asset('assets/images/products/product-16-c1.jpg')}}" alt="Long sleeve overall">
																</span>
																</span>
                                                        </a>
                                                ...
                                                <li class="item product product-item">
                                                    <div class="product">
                                                        <a class="product-item-photo" href="#" title="Lace back mini dress">
																<span class="product-image-container">
																<span class="product-image-wrapper">
																<img class="product-image-photo" src="{{asset('assets/images/products/product-20.jpg')}}" alt="Lace back mini dress">
																</span>
																</span>
                                                        </a>
                                                        <div class="product-item-details">
                                                ...
                                                <li class="item product product-item">
                                                    <div class="product">
                                                        <a class="product-item-photo" href="#" title="Backless mini dress">
																<span class="product-image-container">
																<span class="product-image-wrapper">
																<img class="product-image-photo" src="{{asset('assets/images/products/product-18.jpg')}}" alt="Backless mini dress">
																</span>
																</span>
                                                        </a>
                                                        <div class="product-item-details">
                    ...
                    <div class="header-links">
                        ...
                        <div class="header-link header-select dropdown-link header-language">
                            <a href="#"><img src="{{asset('assets/images/flags/eng.png')}}" alt /></a>
                            <ul class="dropdown-container">
                                <li class="active">
                                    <a href="#"><img src="{{asset('assets/images/flags/eng.png')}}" alt />English</a>
                                </li>
                                <li>
                                    <a href="#"><img src="{{asset('assets/images/flags/fr.png')}}" alt />French</a>
                                </li>
                                <li>
                                    <a href="#"><img src="{{asset('assets/images/flags/den.png')}}" alt />German</a>
                                </li>
                            </ul>
                        </div>
                        <!-- /Header Language -->
                                ...
                                <div class="sub-menu">
                                    <div class="container">
                                        <div class="megamenu-categories column-5">
                                            <!-- megamenu column -->
                                            <div class="col">
                                                <a class="category-image" href="index-2.html"><img src="{{asset('assets/images/layout/layout-1.jpg')}}" alt /></a>
                                                <div class="category-title"><a href="#">Default</a></div>
                                            </div>
                                            <!-- /megamenu column -->
                                            <!-- megamenu column -->
                                            <div class="col">
                                                <a class="category-image" href="index-layout-6.html"><img src="{{asset('assets/images/layout/layout-2.jpg')}}" alt /></a>
                                                <div class="category-title"><a href="#">Fullwidth + Left SideBar</a></div>
                                            </div>
                                            <!-- /megamenu column -->
                                            <!-- megamenu column -->
                                            <div class="col">
                                                <a class="category-image" href="index-layout-1.html"><img src="{{asset('assets/images/layout/layout-3.jpg')}}" alt /></a>
                                                <div class="category-title"><a href="#">Classic</a></div>
                                            </div>
                                            <!-- /megamenu column -->
                                            <!-- megamenu column -->
                                            <div class="col">
                                                <a class="category-image" href="index-layout-3.html"><img src="{{asset('assets/images/layout/layout-4.jpg')}}" alt /></a>
                                                <div class="category-title"><a href="#">Banners Boom</a></div>
                                            </div>
                                            <!-- /megamenu column -->
                                            <!-- megamenu column -->
                                            <div class="col">
                                                <a class="category-image" href="index-layout-4.html"><img src="{{asset('assets/images/layout/layout-6.jpg')}}" alt /></a>
                                    ...
                                    <div class="container">
                                        <div class="megamenu-categories column-5">
                                            <!-- megamenu column -->
                                            <div class="col">
                                                <a class="category-image" href="index-layout-5.html"><img src="{{asset('assets/images/layout/layout-7.jpg')}}" alt /></a>
                                                <div class="category-title"><a href="#">LookBook</a></div>
                                            </div>
                                            <!-- /megamenu column -->
                                            <!-- megamenu column -->
                                            <div class="col">
                                                <a class="category-image" href="index-layout-2.html"><img src="{{asset('assets/images/layout/layout-5.jpg')}}" alt /></a>
                                                <div class="category-title"><a href="#">Journal View</a></div>
                                            </div>
                                            <!-- /megamenu column -->
                                            <!-- megamenu column -->
                                            <div class="col">
                                                <a class="category-image" href="index-rtl.html"><img src="{{asset('assets/images/layout/layout-8.jpg')}}" alt /></a>
                                                <div class="category-title"><a href="#">RTL Mode</a></div>
                                            </div>
                                            <!-- /megamenu column -->
                                            <!-- megamenu column -->
                                            <div class="col">
                                                <a class="category-image" href="index-bg-white.html"><img src="{{asset('assets/images/layout/layout-9.jpg')}}" alt /></a>
                                                <div class="category-title"><a href="#">White Background</a></div>
                                            </div>
                                            <!-- /megamenu column -->
                                            <!-- megamenu column -->
                                            <div class="col">
                                                <a class="category-image" href="gallery.html"><img src="{{asset('asssets/images/layout/layout-10.jpg')}}" alt /></a>
                                ...
                                <div class="sub-menu">
                                    <div class="container">
                                        <div class="megamenu-categories column-4">
                                            <!-- megamenu column -->
                                            <div class="col">
                                                <a class="category-image" href="#"><img src="{{asset('assets/images/category/megamenu-category-03.jpg')}}" alt /></a>
                                            ...
                                            <!-- megamenu column -->
                                            <div class="col">
                                                <a class="category-image" href="#"><img src="{{asset('assets/images/category/megamenu-category-04.jpg')}}" alt /></a>
                                            ...
                                            <!-- megamenu column -->
                                            <div class="col">
                                                <a class="category-image" href="#"><img src="{{asset('assets/images/category/megamenu-category-05.jpg')}}" alt /></a>
                                            ...
                                            <!-- megamenu column -->
                                            <div class="col">
                                                <a class="category-image" href="#"><img src="{{asset('assets/images/category/megamenu-category-06.jpg')}}" alt /></a>
                                ...
                                <div class="sub-menu">
                                    <div class="container">
                                        ...
                                        <div class="megamenu-categories column-2">
                                            <!-- megamenu column 1 -->
                                            <div class="col">
                                                <a class="category-image" href="#"><img src="{{asset('assets/images/category/megamenu-category-01-1.jpg')}}" alt /></a>
                                            ...
                                            <!-- megamenu column 2 -->
                                            <div class="col">
                                                <a class="category-image" href="#"><img src="{{asset('assets/images/category/megamenu-category-02-1.jpg')}}" alt /></a>
                                            ...
                                            <div class="megamenu-bottom">
                                                <a href="#"><img class="img-responsive" src="{{asset('assets/images/banners/banner-megamenu.jpg')}}" alt="megamenu banner"></a>
                                            </div>
                                            <!-- /megamenu bottom -->
                                        </div>
                                    </div>
                                ...
                                <div class="sub-menu">
                                    <div class="container">
                                        <div class="megamenu-left width-33">
                                            <a href="#bannerLink" class="banner-wrap">
                                                <div class="banner style-13 autosize-text image-hover-scale" data-fontratio="4">
                                                    <img src="{{asset('assets/images/banners/banner-21.jpg')}}" alt="Banner">
                                        ...
                                        <div class="megamenu-categories column-3">
                                            <!-- megamenu column 1 -->
                                            <div class="col">
                                                <a class="category-image light" href="#"><img src="{{asset('assets/images/category/megamenu-category-07.jpg')}}" alt /></a>
                                            ...
                                            <!-- megamenu column 2 -->
                                            <div class="col">
                                                <a class="category-image light" href="#"><img src="{{asset('assets/images/category/megamenu-category-09.jpg')}}" alt /></a>
                                            ...
                                            <div class="col truncateList" data-list-items="7">
                                                <a class="category-image light" href="#"><img src="{{asset('assets/images/category/megamenu-category-08.jpg')}}" alt /></a>
        ...
        <main class="page-main">
                                    ...
                                    <div class="product-item-info">
                                        ...
                                        <div class="product-item-photo">
                                            ...
                                            <div class="product-item-gallery-main">
                                                <a href="#"><img class="product-image-photo" src="{{asset('assets/images/products/product-16-c1.jpg')}}" alt=""></a>
                                        ...
                                        <div class="product-item-details">
                                            ...
                                            <ul class="color-swatch hidden-xs">
                                                <li class="active">
                                                    <a data-image="{{asset('assets/images/products/product-16-c1.jpg')}}" href="#"><img src="{{asset('assets/images/colorswatch/color-blue.png')}}" alt="Blue"></a>
                                                </li>
                                                <li>
                                                    <a data-image="{{asset('assets/images/products/product-16-c2.jpg')}}" href="#"><img src="{{asset('assets/images/colorswatch/color-grey.png')}}" alt="Gray"></a>
                                                </li>
                                                <li>
                                                    <a data-image="{{asset('assets/images/products/product-16-c3.jpg')}}" href="#"><img src="{{'assets/images/colorswatch/color-red.png'}}" alt="Red"></a>
                                                </li>
                                                <li>
                                                    <a data-image="{{asset('assets/images/products/product-16-c4.jpg')}}" href="#"><img src="{{asset('assets/images/colorswatch/color-violet.png')}}" alt="Violet"></a>
                                                </li>
                                                <li>
                                                    <a data-image="{{asset('assets/images/products/product-16-c4.jpg')}}" href="#"><img src="{{asset('assets/images/colorswatch/color-green.png')}}" alt="Green"></a>
                                                </li>
                                            </ul>
                                            ...
                                            <div class="carousel-inside slide" data-ride="carousel">
                                                <div class="carousel-inner" role="listbox">
                                                    <div class="item active">
                                                        <a href="#"><img class="product-image-photo" src="{{asset('assets/images/products/product-20.jpg')}}" alt=""></a>
                                                    </div>
                                                    <div class="item">
                                                        <a href="#"><img class="product-image-photo" src="{{asset('assets/images/products/product-20-1.jpg')}}" alt=""></a>
                                                    </div>
                                                    <div class="item">
                                                        <a href="#"><img class="product-image-photo" src="{{asset('assets/images/products/product-20-2.jpg')}}" alt=""></a>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="product-item-info">
                                        ...
                                        <div class="product-item-photo">
                                            ...
                                            <div class="product-item-gallery">
                                                <!-- product main photo -->
                                                <div class="product-item-gallery-main">
                                                    <a href="#"><img class="product-image-photo" src="{{asset('assets/images/products/product-26.jpg')}}" alt=""></a>
                                                    <a href="quick-view.html" title="Quick View" class="quick-view-link quick-view-btn"> <i class="icon icon-eye"></i><span>Quick View</span></a>
                                                </div>
                                                <!-- /product main photo  -->
                                            </div>
                                            ...
                                            <div class="product-item-gallery-previews-wrapper">
                                                <div class="product-item-gallery-previews">
                                                    <div class="item">
                                                        <a href="#"><img src="{{asset('assets/images/products/product-26.jpg')}}" data-image="{{asset('assets/images/products/product-26.jpg')}}" alt=""></a>
                                                    </div>
                                                    <div class="item">
                                                        <a href="#"><img src="{{asset('assets/images/products/product-26-1.jpg')}}" data-image="{{asset('assets/images/products/product-26-1.jpg')}}" alt=""></a>
                                                    </div>
                                                    <div class="item">
                                                        <a href="#"><img src="{{asset('assets/images/products/product-26-2.jpg')}}" data-image="{{asset('assets/images/products/product-26-2.jpg')}}" alt=""></a>
                                                    </div>
                                                </div>
                                ...
                                <div class="product-item-inside">
                                    <div class="product-item-info">
                                        ...
                                        <div class="product-item-photo">
                                            ...
                                            <!-- product main photo -->
                                            <div class="product-item-gallery-main">
                                                <a href="#"><img class="product-image-photo" src="{{asset('assets/images/products/product-25.jpg')}}" alt=""></a>
                                                <a href="quick-view.html" title="Quick View" class="quick-view-link quick-view-btn"> <i class="icon icon-eye"></i><span>Quick View</span></a>
                                            </div>
                                            <!-- /product main photo  -->
                                            <div class="countdown-box hidden-xs">
                                            ...
                                            <div class="product-item-gallery-previews-wrapper">
                                                <div class="product-item-gallery-previews">
                                                    <div class="item">
                                                        <a href="#"><img src="{{asset('assets/images/products/product-25.jpg')}}" data-image="{{asset('assets/images/products/product-25.jpg')}}" alt=""></a>
                                                    </div>
                                                    <div class="item">
                                                        <a href="#"><img src="{{asset('assets/images/products/product-25-1.jpg')}}" data-image="{{asset('assets/images/products/product-25-1.jpg')}}" alt=""></a>
                                                    </div>
                                                </div>
                                                <div class="carousel-arrows"></div>
                                            </div>
                                    ...
                                    <div class="product-item-info">
                                        ...
                                        <div class="product-item-photo">
                                            <div class="product-item-gallery">
                                                <!-- product main photo -->
                                                <div class="product-item-gallery-main">
                                                    <a href="#"><img class="product-image-photo" src="{{asset('assets/images/products/product-18.jpg')}}" alt=""></a>
                                                    <a href="quick-view.html" title="Quick View" class="quick-view-link quick-view-btn"> <i class="icon icon-eye"></i><span>Quick View</span></a>
                                                </div>
                                                <!-- /product main photo  -->
                                            </div>
                                            ...
                                            <div class="product-item-gallery-previews-wrapper">
                                                <div class="product-item-gallery-previews">
                                                    <div class="item">
                                                        <a href="#"><img src="{{asset('assets/images/products/product-18.jpg')}}" data-image="{{asset('assets/images/products/product-18.jpg')}}" alt=""></a>
                                                    </div>
                                                    <div class="item">
                                                        <a href="#"><img src="{{asset('assets/images/products/product-18-1.jpg')}}" data-image="{{asset('assets/images/products/product-18-1.jpg')}}" alt=""></a>
                                                    </div>
                                                </div>
                                                <div class="carousel-arrows"></div>
                                            </div>
                                        ...
                                        <!-- Product Details -->
                                        <div class="product-item-details">
                                            <div class="product-item-name"> <a title="Backless mini dress" href="product.html" class="product-item-link">Backless mini dress</a> </div>
                                            <div class="product-item-description">Neque porro quisquam est, qui dolorem ipsum quia dolor sit amet, consectetur, adipisci velit, sed quia nonkdni numquam eius modi tempora incidunt ut labore</div>
                                    ...
                                    <div class="product-item-info">
                                        ...
                                        <div class="product-item-photo">
                                            ...
                                            <div class="product-item-gallery">
                                                <!-- product main photo -->
                                                <div class="product-item-gallery-main">
                                                    <a href="#"><img class="product-image-photo" src="{{asset('assets/images/products/product-10.jpg')}}" alt=""></a>
                                                    <a href="quick-view.html" title="Quick View" class="quick-view-link quick-view-btn"> <i class="icon icon-eye"></i><span>Quick View</span></a>
                                                </div>
                                                <!-- /product main photo  -->
                                            </div>
                                        ...
                                        <!-- Product Details -->
                                        <div class="product-item-details">
                                            <div class="product-item-name"> <a title="Longline  asymmetric midi skirt" href="product.html" class="product-item-link">Longline  asymmetric midi skirt</a> </div>
                                            <div class="product-item-description">Neque porro quisquam est, qui dolorem ipsum quia dolor sit amet, consectetur, adipisci velit, sed quia nonkdni numquam eius modi tempora incidunt ut labore</div>
                                ...
                                <div class="product-item-inside">
                                    <div class="product-item-info">
                                        ...
                                        <div class="product-item-photo">
                                            ...
                                            <!-- product main photo -->
                                            <div class="product-item-gallery-main">
                                                <a href="#"><img class="product-image-photo" src="{{asset('assets/images/products/product-17.jpg')}}" alt=""></a>
                                                <a href="quick-view.html" title="Quick View" class="quick-view-link quick-view-btn"> <i class="icon icon-eye"></i><span>Quick View</span></a>
                                            ...
                                            <div class="product-item-gallery-previews-wrapper">
                                                <div class="product-item-gallery-previews">
                                                    <div class="item">
                                                        <a href="#"><img src="{{asset('assets/images/products/product-17.jpg')}}" data-image="{{asset('assets/images/products/product-17.jpg')}}" alt=""></a>
                                                    </div>
                                                    <div class="item">
                                                        <a href="#"><img src="{{asset('assets/images/products/product-17-1.jpg')}}" data-image="{{asset('assets/images/products/product-17-1.jpg')}}" alt=""></a>
                                                    </div>
                                                    <div class="item">
                                                        <a href="#"><img src="{{asset('assets/images/products/product-17-2.jpg')}}" data-image="{{asset('assets/images/products/product-17-2.jpg')}}" alt=""></a>
                                                    </div>
                                                </div>
                                                <div class="carousel-arrows"></div>
                                            </div>
                                    ...
                                    <div class="product-item-info">
                                        ...
                                        <div class="product-item-photo">
                                            ...
                                            <div class="product-item-gallery">
                                                <!-- product main photo -->
                                                <div class="product-item-gallery-main">
                                                    <a href="#"><img class="product-image-photo" src="{{asset('assets/images/products/product-27.jpg')}}" alt=""></a>
                                                    <a href="quick-view.html" title="Quick View" class="quick-view-link quick-view-btn"> <i class="icon icon-eye"></i><span>Quick View</span></a>
                                                </div>
                                                <!-- /product main photo  -->
                                            </div>
                                        ...
                                        <!-- Product Details -->
                                        <div class="product-item-details">
                                            <div class="product-item-name"> <a title="Athletic T-Shirt" href="product.html" class="product-item-link">Athletic T-Shirt</a> </div>
                                            <div class="product-item-description">Neque porro quisquam est, qui dolorem ipsum quia dolor sit amet, consectetur, adipisci velit, sed quia nonkdni numquam eius modi tempora incidunt ut labore</div>
            ...
            <div class="block fullwidth full-nopad bottom-space">
                <div class="container">
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="banner style-7 autosize-text image-hover-scale" data-fontratio="9.6"><img src="{{asset('assets/images/banners/banner-layout-5.jpg')}}" alt="Banner">
                        ...
                        <div class="col-sm-6">
                            <div class="banner style-8 autosize-text image-hover-scale" data-fontratio="10"><img src="{{asset('assets/images/banners/banner-layout-6.jpg')}}" alt="Banner">
                                <div class="banner-caption horr vertc">
                                    <div class="vert-wrapper">
                                        <div class="vert">
                    ...
                    <div class="row">
                        <div class="col-md-5 col-lg-6">
                            ...
                            <div class="blog-carousel">
                                <div class="blog-item">
                                    <a href="blog.html" class="blog-item-photo"> <img class="product-image-photo" src="{{asset('assets/images/blog/blog-1.jpg')}}" alt="From Blog"> </a>
                                ...
                                <!-- Blog Carousel Item -->
                                <div class="blog-item">
                                    <a href="blog.html" class="blog-item-photo"> <img class="product-image-photo" src="{{asset('assets/images/blog/blog-2.jpg')}}" alt="From Blog"> </a>
                                    <div class="blog-item-info">
                                ...
                                <!-- Blog Carousel Item -->
                                <div class="blog-item">
                                    <a href="blog.html" class="blog-item-photo"> <img class="product-image-photo" src="{{asset('assets/images/blog/blog-3.jpg')}}" alt="From Blog"> </a>
                                    <div class="blog-item-info">
                                ...
                                <!-- Blog Carousel Item -->
                                <div class="blog-item">
                                    <a href="blog.html" class="blog-item-photo"> <img class="product-image-photo" src="{{asset('assets/images/blog/blog-4.jpg')}}" alt="From Blog"> </a>
                                    <div class="blog-item-info">
                                        ...
                                        <div class="product-item-inside">
                                            <div class="product-item-info">
                                                ...
                                                <div class="product-item-photo">
                                                    <!-- product main photo -->
                                                    <div class="product-item-gallery-main">
                                                        <a href="#"><img class="product-image-photo" src="{{asset('assets/images/products/product-19.jpg')}}" alt=""></a>
                                                        <a href="quick-view.html" title="Quick View" class="quick-view-link quick-view-btn"> <i class="icon icon-eye"></i><span>Quick View</span></a>
                                                    </div>
                                                    <!-- /product main photo  -->
                                                    <!-- Product Label -->
                                                    ...
                                                    <div class="product-item-gallery-previews-wrapper">
                                                        <div class="product-item-gallery-previews">
                                                            <div class="item">
                                                                <a href="#"><img src="{{asset('assets/images/products/product-19.jpg')}}" data-image="{{asset('assets/images/products/product-19.jpg')}}" alt =""></a>
                                                            </div>
                                                            <div class="item">
                                                                <a href="#"><img src="{{asset('assets/images/products/product-19-1.jpg')}}" data-image="{{asset('assets/images/products/product-19-1.jpg')}}" alt=""></a>
                                                            </div>
                                                            <div class="item">
                                                                <a href="#"><img src="{{asset('assets/images/products/product-19-2.jpg')}}" data-image="{{asset('assets/images/products/product-19-2.jpg')}}" alt=""></a>
                                                            </div>
                                                            <div class="item">
                                                                <a href="#"><img src="{{asset('assets/images/products/product-19-3.jpg')}}" data-image="{{asset('assets/images/products/product-19-3.jpg')}}" alt=""></a>
                                                            </div>
                                                        </div>
                                                        <div class="carousel-arrows"></div>
                                                    </div>
                                                ...
                                                <div class="product-item-details">
                                                    ...
                                                    <ul class="color-swatch hidden-xs">
                                                        <li class="active">
                                                            <a data-image="images/products/product-19.jpg" href="#"><img src="{{asset('assets/images/colorswatch/color-yellow.png')}}" alt="Yellow"></a>
                                                        </li>
                                                        <li>
                                                            <a data-image="images/products/product-19-c1.jpg" href="#"><img src="{{asset('assets/images/colorswatch/color-blue.png')}}" alt="Blue"></a>
                                                        </li>
                                                        <li>
                                                            <a data-image="images/products/product-19-c2.jpg" href="#"><img src="{{asset('assets/images/colorswatch/color-red.png')}}" alt="Red"></a>
                                                        </li>
                                                        <li>
                                                            <a data-image="images/products/product-19-c3.jpg" href="#"><img src="{{asset('assets/images/colorswatch/color-grey.png')}}" alt="Grey"></a>
                                                        </li>
                                                        <li>
                                                            <a data-image="images/products/product-19-c4.jpg" href="#"><img src="{{asset('assets/images/colorswatch/color-green.png')}}" alt="Green"></a>
                                                        </li>
                                                        <li>
                                                            <a data-image="images/products/product-19-c5.jpg" href="#"><img src="{{asset('assets/images/colorswatch/color-violet.png')}}" alt="Violet"></a>
                                                        </li>
                                                    </ul>
                                                    <div class="product-item-rating"> <i class="icon icon-star-fill"></i><i class="icon icon-star-fill"></i><i class="icon icon-star-fill"></i><i class="icon icon-star-fill"></i><i class="icon icon-star-fill"></i></div>
                                                    <button class="btn add-to-cart" data-product="789123"> <i class="icon icon-cart"></i><span>Add to Cart</span> </button>
                                            ...
                                            <div class="product-item-info">
                                                ...
                                                <div class="product-item-photo">
                                                    ...
                                                    <div class="product-item-gallery">
                                                        <!-- product main photo -->
                                                        <div class="product-item-gallery-main">
                                                            <a href="#"><img class="product-image-photo" src="{{asset('assets/images/products/product-13.jpg')}}" alt=""></a>
                                                            <a href="quick-view.html" title="Quick View" class="quick-view-link quick-view-btn"> <i class="icon icon-eye"></i><span>Quick View</span></a>
                                                        </div>
                                                        <!-- /product main photo  -->
                                                    </div>
                                        ...
                                        <div class="product-item-inside">
                                            <div class="product-item-info">
                                                ...
                                                <div class="product-item-photo">
                                                    ...
                                                    <!-- product main photo -->
                                                    <div class="product-item-gallery-main">
                                                        <a href="#"><img class="product-image-photo" src="{{asset('assets/images/products/product-11-1.jpg')}}" alt=""></a>
                                                        <a href="quick-view.html" title="Quick View" class="quick-view-link quick-view-btn"> <i class="icon icon-eye"></i><span>Quick View</span></a>
                                                    </div>
                                                    <!-- /product main photo  -->
                                                    <!-- Product Actions -->
                                                    ...
                                                    <div class="product-item-gallery-previews-wrapper">
                                                        <div class="product-item-gallery-previews">
                                                            <div class="item">
                                                                <a href="#"><img src="{{asset('assets/images/products/product-11.jpg')}}" data-image="{{asset('assets/images/products/product-11.jpg')}}" alt=""></a>
                                                            </div>
                                                            <div class="item">
                                                                <a href="#"><img src="{{asset('assets/images/products/product-11-1.jpg')}}" data-image="{{asset('assets/images/products/product-11-1.jpg')}}" alt=""></a>
                                                            </div>
                                                            <div class="item">
                                                                <a href="#"><img src="{{asset('assets/images/products/product-11-2.jpg')}}" data-image="{{asset('assets/images/products/product-11-2.jpg')}}" alt=""></a>
                                                            </div>
                                                        </div>
                                                        <div class="carousel-arrows"></div>
                                                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-6 col-lg-8">
                            <div class="image-banner text-center">
                                <a href="#"> <img src="{{asset('assets/images/banners/footer-banner.jpg')}}" alt="Footer Banner" class="img-responsive"> </a>
                            </div>
                        </div>
                        <div class=" col-md-6 col-lg-4">
                            <div class="footer-copyright text-center"> © 2016 Demo Store. All Rights Reserved. </div>
                            <div class="footer-payment-link text-center">
                                <a href="#"><img src="{{asset('assets/images/payment-logo/icon-pay-1.png')}}" alt=""></a>
                                <a href="#"><img src="{{asset('assets/images/payment-logo/icon-pay-2.png')}}" alt=""></a>
                                <a href="#"><img src="{{asset('assets/images/payment-logo/icon-pay-3.png')}}" alt=""></a>
                                <a href="#"><img src="{{asset('assets/images/payment-logo/icon-pay-4.png')}}" alt=""></a>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="productstack-content">
        <div class="products-list-wrapper">
            <ul class="products-list">
                <li>
                    <a href="product.html" title="Product Name Long Name"><img class="product-image-photo" src="{{asset('assets/images/products/product-10.jpg')}}" alt=""></a>
                ...
                <li>
                    <a href="product.html" title="Product Name Long Name"><img class="product-image-photo" src="{{asset('assets/images/products/product-11.jpg')}}" alt=""></a>
                    <span class="item-qty">3</span>
                    <div class="actions">
                ...
                <li>
                    <a href="product.html" title="Product Name Long Name"><img class="product-image-photo" src="{{asset('assets/images/products/product-12.jpg')}}" alt=""></a>
                    <span class="item-qty">3</span>
                    <div class="actions">
                        <a class="action edit" href="#" title="Edit item"><i class="icon icon-pencil"></i></a>
                        <a class="action delete" href="#" title="Delete item"><i class="icon icon-trash-alt"></i></a>
                ...
                <li>
                    <a href="product.html" title="Product Name Long Name"><img class="product-image-photo" src="{{asset('assets/images/products/product-13.jpg')}}" alt=""></a>
                    <span class="item-qty">3</span>
                    <div class="actions">
                        <a class="action edit" href="#" title="Edit item"><i class="icon icon-pencil"></i></a>
                        <a class="action delete" href="#" title="Delete item"><i class="icon icon-trash-alt"></i></a>
                ...
                <li>
                    <a href="product.html" title="Product Name Long Name"><img class="product-image-photo" src="{{asset('assets/images/products/product-14.jpg')}}" alt=""></a>
                    <span class="item-qty">3</span>
                    <div class="actions">
                        <a class="action edit" href="#" title="Edit item"><i class="icon icon-pencil"></i></a>
                        <a class="action delete" href="#" title="Delete item"><i class="icon icon-trash-alt"></i></a>
                ...
                <li>
                    <a href="product.html" title="Product Name Long Name"><img class="product-image-photo" src="{{asset('assets/images/products/product-15.jpg')}}" alt=""></a>
                    <span class="item-qty">3</span>
                    <div class="actions">
                        <a class="action edit" href="#" title="Edit item"><i class="icon icon-pencil"></i></a>
                        <a class="action delete" href="#" title="Delete item"><i class="icon icon-trash-alt"></i></a>
...
<!-- Mirrored from frontend.big-skins.com/seiko/html/ by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 17 Jul 2023 13:38:01 GMT -->
</html>
