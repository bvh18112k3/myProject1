...
<div class="fixed-btns demo-mode">
    ...
    <div id="toolsPanel">
        <div class="btn-wrapper tools-btn">
            <a href="#" class="btn"><img src="images/animate-tools.gif" class="img-responsive" alt=""></a>
        </div>
                                                ...
                                                <li class="item product product-item">
                                                    <div class="product">
                                                        <a class="product-item-photo" href="#" title="Backless mini dress">
																<span class="product-image-container">
																<span class="product-image-wrapper">
																<img class="product-image-photo" src="images/products/product-18.jpg" alt="Backless mini dress">
																</span>
																</span>
                                                        </a>
                                                        <div class="product-item-details">
                                ...
                                <div class="sub-menu">
                                    <div class="container">
                                        <div class="megamenu-categories column-5">
                                            <!-- megamenu column -->
                                            <div class="col">
                                                <a class="category-image" href="index-2.html"><img src="images/layout/layout-1.jpg" alt /></a>
                                                <div class="category-title"><a href="#">Default</a></div>
                                            </div>
                                            <!-- /megamenu column -->
                                            <!-- megamenu column -->
                                            <div class="col">
                                                <a class="category-image" href="index-layout-6.html"><img src="images/layout/layout-2.jpg" alt /></a>
                                                <div class="category-title"><a href="#">Fullwidth + Left SideBar</a></div>
                                            </div>
                                            <!-- /megamenu column -->
                                            <!-- megamenu column -->
                                            <div class="col">
                                                <a class="category-image" href="index-layout-1.html"><img src="images/layout/layout-3.jpg" alt /></a>
                                                <div class="category-title"><a href="#">Classic</a></div>
                                            </div>
                                            <!-- /megamenu column -->
                                            <!-- megamenu column -->
                                            <div class="col">
                                                <a class="category-image" href="index-layout-3.html"><img src="images/layout/layout-4.jpg" alt /></a>
                                                <div class="category-title"><a href="#">Banners Boom</a></div>
                                            </div>
                                            <!-- /megamenu column -->
                                            <!-- megamenu column -->
                                            <div class="col">
                                                <a class="category-image" href="index-layout-4.html"><img src="images/layout/layout-6.jpg" alt /></a>
                                    ...
                                    <div class="container">
                                        <div class="megamenu-categories column-5">
                                            <!-- megamenu column -->
                                            <div class="col">
                                                <a class="category-image" href="index-layout-5.html"><img src="images/layout/layout-7.jpg" alt /></a>
                                                <div class="category-title"><a href="#">LookBook</a></div>
                                            </div>
                                            <!-- /megamenu column -->
                                            <!-- megamenu column -->
                                            <div class="col">
                                                <a class="category-image" href="index-layout-2.html"><img src="images/layout/layout-5.jpg" alt /></a>
                                                <div class="category-title"><a href="#">Journal View</a></div>
                                            </div>
                                            <!-- /megamenu column -->
                                            <!-- megamenu column -->
                                            <div class="col">
                                                <a class="category-image" href="index-rtl.html"><img src="images/layout/layout-8.jpg" alt /></a>
                                                <div class="category-title"><a href="#">RTL Mode</a></div>
                                            </div>
                                            <!-- /megamenu column -->
                                            <!-- megamenu column -->
                                            <div class="col">
                                                <a class="category-image" href="index-bg-white.html"><img src="images/layout/layout-9.jpg" alt /></a>
                                                <div class="category-title"><a href="#">White Background</a></div>
                                            </div>
                                            <!-- /megamenu column -->
                                            <!-- megamenu column -->
                                            <div class="col">
                                                <a class="category-image" href="gallery.html"><img src="images/layout/layout-10.jpg" alt /></a>
                                ...
                                <div class="sub-menu">
                                    <div class="container">
                                        ...
                                        <div class="megamenu-categories column-2">
                                            <!-- megamenu column 1 -->
                                            <div class="col">
                                                <a class="category-image" href="#"><img src="images/category/megamenu-category-01-1.jpg" alt /></a>
                                            ...
                                            <!-- megamenu column 2 -->
                                            <div class="col">
                                                <a class="category-image" href="#"><img src="images/category/megamenu-category-02-1.jpg" alt /></a>
        ...
        <main class="page-main">
            ...
            <div class="block fullwidth full-nopad bottom-space">
                <div class="container">
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="banner style-7 autosize-text image-hover-scale" data-fontratio="9.6"><img src="images/banners/banner-layout-5.jpg" alt="Banner">
                        ...
                        <div class="col-sm-6">
                            <div class="banner style-8 autosize-text image-hover-scale" data-fontratio="10"><img src="images/banners/banner-layout-6.jpg" alt="Banner">
                                <div class="banner-caption horr vertc">
                                    <div class="vert-wrapper">
                                        <div class="vert">
